...
eval_dataset = MusicSamplerDataset(data_eval, SEQ_LEN) # train in chunks of SEQ_LEN
...
for epoch in range(0, EPOCHS):
    ...
    loss = train_and_eval(epoch+1, 
                 ...
                 opt, 
                 lr_scheduler, 
                 save_checkpoint_steps=20000, # autosave checkpoints frequency, in tokens
                 tensorboard_steps=400,
                 device=device) 
