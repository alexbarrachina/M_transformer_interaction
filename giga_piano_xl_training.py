...
if(USE_TENSORBOARD):
    tensorboard_summary = SummaryWriter(log_dir='./rpr')
...
dataset_addr = "../DataSets/grandMIDI/midis"

print(os.walk(dataset_addr))
...
print('=' * 70)
TMIDIX.Tegridy_Any_Pickle_File_Writer(train_data1, './Training-Data/processedMIDIs')        
print('Done!')   
print('=' * 70)
...
#train_data1 = pickle5.load(open('/.Training-Data/GP-Perceiver-Training-Data.pickle', 'rb'))
...
if len(out1) != 0:
    ...
    detailed_stats = TMIDIX.Tegridy_SONG_to_MIDI_Converter(song_f,
                                                        ...
                                                        output_file_name = './Out/GIGA-Piano-XL-Music-Composition-training', 
...
best_acc_file = './rpr/gpt2_rpr_acc.pth'
best_loss_file = './rpr/gpt2_rpr_loss.pth'
...
for epoch in range(0, epochs):
    ...
    if(USE_TENSORBOARD):
        tensorboard_summary.add_scalar("train_loss", loss, global_step=epoch+1)
        tensorboard_summary.add_scalar("eval_loss", eval_loss, global_step=epoch+1)
        tensorboard_summary.add_scalar("eval_acc", eval_acc, global_step=epoch+1)  
        tensorboard_summary.add_scalar("lr", lr_scheduler, global_step=epoch+1)
...
full_path_to_model_checkpoint = "./Model/GIGA-Piano-XL-Trained-Model-alex.pth" #@param {type:"string"}
