...
MODELS_FILE_NAMES = {'without velocity - 7 epochs': './save_models/Monster_Piano_Transformer_No_Velocity_Trained_Model_161960_steps_0.7775_loss_0.7661_acc.pth',
                     'without velocity - 3 epochs': './save_models/Monster_Piano_Transformer_No_Velocity_Trained_Model_69412_steps_0.8577_loss_0.7442_acc.pth',
                     'with velocity - 3 epochs': './save_models/Monster_Piano_Transformer_Velocity_Trained_Model_59896_steps_0.9055_loss_0.735_acc.pth',
                     'velocity inpainting - 2 epochs': './save_models/Monster_Piano_Transformer_Velocity_Inpaiting_Trained_Model_38777_steps_0.9227_loss_0.734_acc.pth',
                     'timings inpainting - 2 epochs': './save_models/Monster_Piano_Transformer_Timings_Inpainting_Trained_Model_38402_steps_0.622_loss_0.8218_acc.pth',
                     'bridge inpainting - 2 epochs': './save_models/Monster_Piano_Transformer_Bridge_Inpainting_Trained_Model_53305_steps_0.825_loss_0.7578_acc.pth',
                     'chords progressions - 3 epochs': './save_models/Monster_Piano_Transformer_Chords_Progressions_Trained_Model_31648_steps_0.8085_loss_0.7868_acc.pth',
                     'chords texturing - 3 epochs': './save_models/Monster_Piano_Transformer_Chords_Texturing_Trained_Model_33878_steps_0.6109_loss_0.8234_acc.pth'
                    }
